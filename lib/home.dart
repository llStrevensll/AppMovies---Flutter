  ...
  Widget build(BuildContext context) {
   return new Scaffold(
     appBar: new AppBar(
       ...
       actions: <Widget>[
         new IconButton(//icono de busqueda
            icon: new Icon(Icons.search, color: Colors.white),
            onPressed: () {},
         )
       ],
     ),
     drawer: new Drawer(//menu del lado izquierdo
        child: new ListView(
          children: <Widget>[
            new DrawerHeader(child: new Material()),//header
            new ListTile(//lista de opciones
            ...
            new ListTile(//lista de opciones
              title: new Text("Cerrar"),
                ...
                onTap: () => Navigator.of(context).pop(),//cerrar rutas de la aplicacion
            ),
          ],
        )
     ),
